...
extension Flip2<A, B, T> on F2<A, B, T> {
  T flip(B b, A a) => this(a, b);
}

extension Flip3<A, B, C, T> on F3<A, B, C, T> {
  T flip(C c, B b, A a) => this(a, b, c);
}

extension Flip4<A, B, C, D, T> on F4<A, B, C, D, T> {
  T flip(D d, C c, B b, A a) => this(a, b, c, d);
}

extension Flip5<A, B, C, D, E, T> on F5<A, B, C, D, E, T> {
  T flip(E e, D d, C c, B b, A a) => this(a, b, c, d, e);
}

extension Flip6<A, B, C, D, E, F, T> on F6<A, B, C, D, E, F, T> {
  T flip(F f, E e, D d, C c, B b, A a) => this(a, b, c, d, e, f);
}

extension Flip7<A, B, C, D, E, F, G, T> on F7<A, B, C, D, E, F, G, T> {
  T flip(G g, F f, E e, D d, C c, B b, A a) => this(a, b, c, d, e, f, g);
}

extension Flip8<A, B, C, D, E, F, G, H, T> on F8<A, B, C, D, E, F, G, H, T> {
  T flip(H h, G g, F f, E e, D d, C c, B b, A a) =>
      this(a, b, c, d, e, f, g, h);
}

extension Flip9<A, B, C, D, E, F, G, H, I, T>
